...
if __name__ == '__main__':
    ...
    for verb in greek_lemmata:
        ...
        present = res['present']
        pers_forms_pres, deponens = create_all_imperfect_non_passive_personal_forms(present)
        ...
        if 'aorist' in res:
            ...
            print(past_aor)
            past_par = create_all_past_personal_forms(res['paratatikos'], verb, 'imperfect', deponens=deponens)
            print(past_par)
    # VERBS #
    ...
    #    'προτίθεμαι':
    #
    zw = create_all_imperfect_non_passive_personal_forms('ζω')
    print(zw)