...
res = verb.create_all_forms('συνέρχομαι')
print(res)
    ...
    def test_verb_tragoudo(self):
        self.assertEqual(
            ...
            {'present': {'active': {'ind': {
                ...
                'pl': {'pri': {'τραγουδάμε', 'τραγουδούμε'}, 'sec': {'τραγουδάτε'},
                       'ter': {'τραγουδάν', 'τραγουδούνε', 'τραγουδούν', 'τραγουδάνε'}}},
                         ...
                         'passive': {
                             ...
                             'imp': {'pl': {'sec': {'τραγουδιέστε'}}}}}, 'conjunctive': {'active': {
                ...
                'imp': {'sg': {'sec': {'τραγουδήσου'}}, 'pl': {'sec': {'τραγουδηθείτε'}}}}}, 'aorist': {'active': {
                ...
                'ind': {'sg': {'pri': {'τραγουδήθηκα'}, 'sec': {'τραγουδήθηκες'}, 'ter': {'τραγουδήθηκε'}},
                        'pl': {'pri': {'τραγουδηθήκαμε'}, 'sec': {'τραγουδηθήκατε'},
                               'ter': {'τραγουδηθήκανε', 'τραγουδήθηκαν'}}}}}, 'paratatikos': {'active': {'ind': {
