...
,
                 ...
                 {'sg':
                  ...
                  'pl':
                      {'neut':
                       ...
                       'fem':
                           {'nom': {'ανακατωσούρες'}, 'acc': {'ανακατωσούρες'}, 'gen': {'ανακατωσούων'}, 'voc': {'ανακατωσούρες'}}}}, 'adv': {'ανακατωσούρικα'}}
    ...
    def test_diattontas(self):
        self.assertDictEqual(
            ...
            {'adj':
                 {'sg':
                      {'neut': {'voc': {'διάττον'}, 'nom': {'διάττον'}, 'acc': {'διάττον'}, 'gen': {'διάττοντος'}},
                        'fem': {'voc': {'διάττούσα'}, 'nom': {'διάττούσα'}, 'acc': {'διάττούσα'},
                                    'gen': {'διάττούσας'}},
                        'masc': {'voc': {'διάττοντα'}, 'nom': {'διάττοντας'}, 'acc': {'διάττοντα'},
                                     'gen': {'διάττοντα'}}},
                  'pl': {
                'neut': {'voc': {'διάττοντα'}, 'nom': {'διάττοντα'}, 'acc': {'διάττοντα'}, 'gen': {'διαττόντων'}},
                'fem': {'voc': {'διάττούσες'}, 'nom': {'διάττούσες'}, 'acc': {'διάττούσες'}, 'gen': {'διαττουσών'}},
                'masc': {'voc': {'διάττοντες'}, 'nom': {'διάττοντες'}, 'acc': {'διάττοντες'}, 'gen': {'διαττόντων'}}}}}
