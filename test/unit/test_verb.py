        ...
        self.assertDictEqual(
            ...
            {'present':
                  ...
                  'passive':
                      {'ind':
                           {'sg':
                            ...
                            'pl':
                                {'pri': {'ποιούμαστε', 'ποιούμεθα'}, 'sec': {'ποιείστε', 'ποιείσθε'}, 'ter': {'ποιούνται'}}},
                       'imp':
                           {'pl': {'sec': {'ποιείστε'}}}}},
             'conjunctive':
                 {'active':
             ...
             'aorist':
                 {'active':
                      {'ind':
                           {'sg': {'pri': {'ποίησα', 'ποιήσα'}, 'sec': {'ποίησες', 'ποιήσες'}, 'ter': {'ποιήσε', 'ποίησε'}},
                            'pl': {'pri': {'ποιήσαμε'}, 'sec': {'ποιήσατε'}, 'ter': {'ποίησαν', 'ποιήσαν', 'ποιήσανε'}}}},
                  'passive':
                      {'ind':
             ...
             'paratatikos':
                 {'active':
                  ...
                  'passive':
                      {'ind':
                           {'sg': {'pri': {'ποιόμουνα', 'ποιόμουν', 'ποιούμουν'}, 'sec': {'ποιούσουν', 'ποιόσουνα', 'ποιόσουν'}, 'ter': {'ποιούντανε', 'ποιούνταν', 'ποιείτο', 'ποιόταν', 'ποιότανε'}},
                            'pl': {'pri': {'ποιούμαστε', 'ποιόμασταν', 'ποιούμασταν', 'ποιόμαστε'}, 'sec': {'ποιούσαστε', 'ποιούσασταν', 'ποιόσασταν', 'ποιόσαστε'}, 'ter': {'ποιόντουσαν', 'ποιούντανε', 'ποιούνταν', 'ποιόνταν', 'ποιούντο'}}}}},
             'act_pres_participle': {'ποιώντας'},
             'pass_pres_participle':
                 {'pl':
                      {'masc': {'acc': {'ποιούμενους'}, 'gen': {'ποιούμενων'}, 'voc': {'ποιούμενοι'}, 'nom': {'ποιούμενοι'}},
                       'fem': {'acc': {'ποιούμενες'}, 'gen': {'ποιούμενων'}, 'voc': {'ποιούμενες'}, 'nom': {'ποιούμενες'}},
                       'neut': {'acc': {'ποιούμενα'}, 'gen': {'ποιούμενων'}, 'voc': {'ποιούμενα'}, 'nom': {'ποιούμενα'}}},
                  'sg':
                      {'masc': {'acc': {'ποιούμενο'}, 'gen': {'ποιούμενου'}, 'voc': {'ποιούμενε'}, 'nom': {'ποιούμενος'}},
                        'fem': {'acc': {'ποιούμενη'}, 'gen': {'ποιούμενης'}, 'voc': {'ποιούμενη'}, 'nom': {'ποιούμενη'}},
                        'neut': {'acc': {'ποιούμενο'}, 'gen': {'ποιούμενου'}, 'voc': {'ποιούμενο'}, 'nom': {'ποιούμενο'}}}},
             'passive_perfect_participle':
                 {'pl':
                      {'masc': {'acc': {'ποιημένους'}, 'gen': {'ποιημένων'}, 'voc': {'ποιημένοι'}, 'nom': {'ποιημένοι'}},
                  ...
                  'sg': {'masc': {'acc': {'ποιημένο'}, 'gen': {'ποιημένου'}, 'voc': {'ποιημένε'}, 'nom': {'ποιημένος'}},
                         ...
                         'neut': {'acc': {'ποιημένο'}, 'gen': {'ποιημένου'}, 'voc': {'ποιημένο'}, 'nom': {'ποιημένο'}}}}}
    ...
    def test_verb_parkaro(self):
        ...
        self.assertDictEqual(
            ...
            {'present': {'active': {'ind': {'sg': {'pri': {'παρκάρω'}, 'sec': {'παρκάρεις'}, 'ter': {'παρκάρει'}},
                                            'pl': {'pri': {'παρκάρουμε'}, 'sec': {'παρκάρετε'}, 'ter': {'παρκάρουν', 'παρκάρουνε'}}},
                                    'imp': {'sg': {'sec': {'πάρκαρε'}}, 'pl': {'sec': {'παρκάρετε'}}}},
                         'passive': {'ind': {'sg': {'pri': {'παρκάρομαι'}, 'sec': {'παρκάρεσαι'}, 'ter': {'παρκάρεται'}},
                                             'pl': {'pri': {'παρκαρόμαστε'}, 'sec': {'παρκάρεστε', 'παρκαρόσαστε'}, 'ter': {'παρκάρονται'}}},
             ...
             'aorist': {'active': {'ind': {'sg': {'pri': {'πάρκαρα'}, 'sec': {'πάρκαρες'}, 'ter': {'πάρκαρε'}},
                                           'pl': {'pri': {'παρκάραμε'}, 'sec': {'παρκάρατε'}, 'ter': {'παρκάρανε', 'πάρκαραν'}}}}},
             'paratatikos': {'active': {'ind': {'sg': {'pri': {'πάρκαρα'}, 'sec': {'πάρκαρες'}, 'ter': {'πάρκαρε'}},
                                                'pl': {'pri': {'παρκάραμε'}, 'sec': {'παρκάρατε'}, 'ter': {'παρκάρανε', 'πάρκαραν'}}}},
                             'passive': {'ind': {'sg': {'pri': {'παρκαρόμουνα', 'παρκαρόμουν'}, 'sec': {'παρκαρόσουν', 'παρκαρόσουνα'}, 'ter': {'παρκαρόταν', 'παρκαρότανε'}},
                                                 'pl': {'pri': {'παρκαρόμαστε', 'παρκαρόμασταν'}, 'sec': {'παρκαρόσασταν', 'παρκαρόσαστε'}, 'ter': {'παρκάρονταν', 'παρκαρόντουσαν'}}}}},
        ...
        self.assertDictEqual(
            ...
            {'present':
                 {'active':
                      {'ind':
                           {'sg':
                                {'pri': {'παίρνω'}, 'sec': {'παίρνεις'}, 'ter': {'παίρνει'}},
                            'pl': {'pri': {'παίρνουμε'}, 'sec': {'παίρνετε'}, 'ter': {'παίρνουνε', 'παίρνουν'}}},
                       'imp':
                           {'sg': {'sec': {'παίρνε'}}, 'pl': {'sec': {'παίρνετε'}}}},
                  'passive':
                      {'ind':
                           {'sg':
                                {'pri': {'παίρνομαι'}, 'sec': {'παίρνεσαι'}, 'ter': {'παίρνεται'}},
                            'pl': {'pri': {'παιρνόμαστε'}, 'sec': {'παιρνόσαστε', 'παίρνεστε'}, 'ter': {'παίρνονται'}}},
                       'imp': {'pl': {'sec': {'παίρνεστε'}}}}},
             'conjunctive':
                 {'active':
                      {'ind':
                           {'sg':
                                {'pri': {'πάρω'}, 'sec': {'πάρεις'}, 'ter': {'πάρει'}},
                            'pl': {'pri': {'πάρουμε'}, 'sec': {'πάρετε'}, 'ter': {'πάρουν', 'πάρουνε'}}},
                       'imp': {'sg': {'sec': {'πάρε'}}, 'pl': {'sec': {'πάρτε'}}}},
                  'passive': {'ind': {'sg': {'pri': {'παρθώ'}, 'sec': {'παρθείς'}, 'ter': {'παρθεί'}},
             ...
             'aorist':
                 {'active':
                      {'ind':
                           {'sg': {'pri': {'πήρα'}, 'sec': {'πήρες'}, 'ter': {'πήρε'}},
                            'pl': {'pri': {'πήραμε'}, 'sec': {'πήρατε'}, 'ter': {'πήρανε', 'πήραν'}}}},
                  'passive': {'ind': {'sg': {'pri': {'πάρθηκα'}, 'sec': {'πάρθηκες'}, 'ter': {'πάρθηκε'}},
                                      'pl': {'pri': {'παρθήκαμε'}, 'sec': {'παρθήκατε'}, 'ter': {'παρθήκανε', 'πάρθηκαν'}}}}},
             'paratatikos':
                 {'active': {'ind':
                                 {'sg': {'pri': {'έπαιρνα'}, 'sec': {'έπαιρνες'}, 'ter': {'έπαιρνε'}},
                                  'pl': {'pri': {'παίρναμε'}, 'sec': {'παίρνατε'}, 'ter': {'έπαιρναν', 'παίρνανε'}}}},
                  'passive': {'ind':
                                  {'sg': {'pri': {'παιρνόμουνα', 'παιρνόμουν'}, 'sec': {'παιρνόσουνα', 'παιρνόσουν'}, 'ter': {'παιρνόταν', 'παιρνότανε'}},
                                   'pl': {'pri': {'παιρνόμαστε', 'παιρνόμασταν'}, 'sec': {'παιρνόσαστε', 'παιρνόσασταν'}, 'ter': {'παίρνονταν', 'παιρνόντουσαν'}}}}},
             'act_pres_participle': {'παίρνοντας'},
             'active_aorist_participle':
                 {'pl':
                      {'fem':
                           {'gen': {'παρουσών'}, 'acc': {'παρούσες'}, 'nom': {'παρούσες'}, 'voc': {'παρούσες'}},
                       'neut':
                           {'gen': {'παρόντων'}, 'acc': {'παρόντα'}, 'nom': {'παρόντα'}, 'voc': {'παρόντα'}},
                       'masc':
                           {'gen': {'παρόντων'}, 'acc': {'παρόντες'}, 'nom': {'παρόντες'}, 'voc': {'παρόντες'}}},
                  'sg':
                      {'fem':
                           {'gen': {'παρούσας'}, 'acc': {'παρούσα'}, 'nom': {'παρούσα'}, 'voc': {'παρούσα'}},
                       'neut':
                           {'gen': {'παρόντος'}, 'acc': {'παρόν'}, 'nom': {'παρόν'}, 'voc': {'παρόν'}},
                       'masc':
                           {'gen': {'παρόντος'}, 'acc': {'παρόντα'}, 'nom': {'παρών'}, 'voc': {'παρών'}}}},
             'passive_perfect_participle':
                 {'pl':
                      {'fem':
                           {'gen': {'παρμένων'}, 'acc': {'παρμένες'}, 'nom': {'παρμένες'}, 'voc': {'παρμένες'}},
                       'neut':
                           {'gen': {'παρμένων'}, 'acc': {'παρμένα'}, 'nom': {'παρμένα'}, 'voc': {'παρμένα'}},
                       'masc':
                           {'gen': {'παρμένων'}, 'acc': {'παρμένους'}, 'nom': {'παρμένοι'}, 'voc': {'παρμένοι'}}},
                  'sg':
                      {'fem':
                           {'gen': {'παρμένης'}, 'acc': {'παρμένη'}, 'nom': {'παρμένη'}, 'voc': {'παρμένη'}},
                       'neut':
                           {'gen': {'παρμένου'}, 'acc': {'παρμένο'}, 'nom': {'παρμένο'}, 'voc': {'παρμένο'}},
                       'masc':
                           {'gen': {'παρμένου'}, 'acc': {'παρμένο'}, 'nom': {'παρμένος'}, 'voc': {'παρμένε'}}}}},
        ...
        self.assertDictEqual(
            ...
            {'present':
             ...
             'paratatikos': {'passive': {'ind':
                                             {'sg': {'pri': {'επιτιθέμην', 'επιτιθόμουν'}, 'sec': {'επιτιθόσουν', 'επιτίθεσο'}, 'ter': {'επιτίθετο', 'επετίθετο', 'επιτιθόταν'}},
                                              'pl': {'pri': {'επιτιθέμεθα', 'επιτιθόμασταν'}, 'sec': {'επιτίθεσθε', 'επιτιθόσασταν'}, 'ter': {'επιτίθεντο', 'επιτιθούνταν'}}}}},
             'passive_aorist_participle':
                 {'pl':
                      {'fem': {'gen': {'επιτεθεισών'}, 'nom': {'επιτεθείσες'}, 'acc': {'επιτεθείσες'}, 'voc': {'επιτεθείσες'}},
                       'neut': {'gen': {'επιτεθέντων'}, 'nom': {'επιτεθέντα'}, 'acc': {'επιτεθέντα'}, 'voc': {'επιτεθέντα'}},
                       'masc': {'gen': {'επιτεθέντων'}, 'nom': {'επιτεθέντες'}, 'acc': {'επιτεθέντες'}, 'voc': {'επιτεθέντες'}}},
                  'sg': {'fem': {'gen': {'επιτεθείσας'}, 'nom': {'επιτεθείσα'}, 'acc': {'επιτεθείσα'}, 'voc': {'επιτεθείσα'}},
                         'neut': {'gen': {'επιτεθέντος'}, 'nom': {'επιτεθέν'}, 'acc': {'επιτεθέν'}, 'voc': {'επιτεθέν'}},
                         'masc': {'gen': {'επιτεθέντος'}, 'nom': {'επιτεθείς'}, 'acc': {'επιτεθέντα'}, 'voc': {'επιτεθείς'}}}},
             'pass_pres_participle':
                 {'pl':
                      {'fem': {'gen': {'επιτιθέμενων'}, 'nom': {'επιτιθέμενες'}, 'acc': {'επιτιθέμενες'}, 'voc': {'επιτιθέμενες'}},
                       'neut': {'gen': {'επιτιθέμενων'}, 'nom': {'επιτιθέμενα'}, 'acc': {'επιτιθέμενα'}, 'voc': {'επιτιθέμενα'}},
                       'masc': {'gen': {'επιτιθέμενων'}, 'nom': {'επιτιθέμενοι'}, 'acc': {'επιτιθέμενους'}, 'voc': {'επιτιθέμενοι'}}},
                  'sg': {'fem': {'gen': {'επιτιθέμενης'}, 'nom': {'επιτιθέμενη'}, 'acc': {'επιτιθέμενη'}, 'voc': {'επιτιθέμενη'}},
                         'neut': {'gen': {'επιτιθέμενου'}, 'nom': {'επιτιθέμενο'}, 'acc': {'επιτιθέμενο'}, 'voc': {'επιτιθέμενο'}},
                         'masc': {'gen': {'επιτιθέμενου'}, 'nom': {'επιτιθέμενος'}, 'acc': {'επιτιθέμενο'}, 'voc': {'επιτιθέμενε'}}}}}
            ...
            {'present':
                  ...
                  'passive':
                      {'ind':
                           {'sg':
                            ...
                            'pl':
                                {'pri': {'δουλευόμαστε'}, 'sec': {'δουλεύεστε', 'δουλευόσαστε'}, 'ter': {'δουλεύονται'}}},
                       'imp':
                           {'pl': {'sec': {'δουλεύεστε'}}}}},
             'conjunctive':
                 {'active':
                  ...
                  'passive':
                      {'ind':
                           {'sg':
                            ...
                            'pl': {'pri': {'δουλευτούμε'}, 'sec': {'δουλευτείτε'}, 'ter': {'δουλευτούνε', 'δουλευτούν'}}},
                       'imp':
             ...
             'aorist':
                 {'active':
                            {'ind':
                                 {'sg':
                                      {'pri': {'δούλευσα', 'δούλεψα'}, 'sec': {'δούλευσες', 'δούλεψες'}, 'ter': {'δούλεψε', 'δούλευσε'}},
                                  'pl': {'pri': {'δουλεύσαμε', 'δουλέψαμε'}, 'sec': {'δουλεύσατε', 'δουλέψατε'}, 'ter': {'δούλευσαν', 'δουλεύσανε', 'δουλέψανε', 'δούλεψαν'}}}},
                  'passive': {'ind': {'sg':
                                          {'pri': {'δουλεύτηκα'}, 'sec': {'δουλεύτηκες'}, 'ter': {'δουλεύτηκε'}},
                                      'pl':
                                          {'pri': {'δουλευτήκαμε'}, 'sec': {'δουλευτήκατε'}, 'ter': {'δουλεύτηκαν', 'δουλευτήκανε'}}}}},
             'paratatikos':
                 {'active':
                      {'ind': {'sg': {'pri': {'δούλευα'}, 'sec': {'δούλευες'}, 'ter': {'δούλευε'}},
                               'pl': {'pri': {'δουλεύαμε'}, 'sec': {'δουλεύατε'}, 'ter': {'δουλεύανε', 'δούλευαν'}}}},
                  'passive': {'ind': {'sg':
                                          {'pri': {'δουλευόμουν', 'δουλευόμουνα'}, 'sec': {'δουλευόσουνα', 'δουλευόσουν'}, 'ter': {'δουλευόταν', 'δουλευότανε'}},
                                      'pl': {'pri': {'δουλευόμαστε', 'δουλευόμασταν'}, 'sec': {'δουλευόσασταν', 'δουλευόσαστε'}, 'ter': {'δουλευόντουσαν', 'δουλεύονταν'}}}}},
             'act_pres_participle': {'δουλεύοντας'},
             'active_aorist_participle': {'sg':
                                              {'fem':
                                                   {'acc': {'δουλεύσασα'}, 'voc': {'δουλεύσασα'}, 'gen': {'δουλεύσασας'}, 'nom': {'δουλεύσασα'}},
                                               'neut':
                                                   {'acc': {'δουλεύσαν'}, 'voc': {'δουλεύσαν'}, 'gen': {'δουλεύσαντος'}, 'nom': {'δουλεύσαν'}},
                                               'masc': {'acc': {'δουλεύσαντα'}, 'voc': {'δουλεύσας'}, 'gen': {'δουλεύσαντος'}, 'nom': {'δουλεύσας'}}},
                                          'pl': {'fem': {'acc': {'δουλεύσασες'}, 'voc': {'δουλεύσασες'}, 'gen': {'δουλευσασών'}, 'nom': {'δουλεύσασες'}},
                                                 'neut': {'acc': {'δουλεύσαντα'}, 'voc': {'δουλεύσαντα'}, 'gen': {'δουλευσάντων'}, 'nom': {'δουλεύσαντα'}},
                                                 'masc': {'acc': {'δουλεύσαντες'}, 'voc': {'δουλεύσαντες'}, 'gen': {'δουλευσάντων'}, 'nom': {'δουλεύσαντες'}}}},
             'passive_perfect_participle': {'sg': {'fem': {'acc': {'δεδουλευμένη', 'δουλευμένη'}, 'voc': {'δεδουλευμένη', 'δουλευμένη'}, 'gen': {'δεδουλευμένης', 'δουλευμένης'}, 'nom': {'δεδουλευμένη', 'δουλευμένη'}},
                                                   'neut': {'acc': {'δεδουλευμένο', 'δουλευμένο'}, 'voc': {'δεδουλευμένο', 'δουλευμένο'}, 'gen': {'δουλευμένου', 'δεδουλευμένου'}, 'nom': {'δεδουλευμένο', 'δουλευμένο'}},
                                                   'masc': {'acc': {'δεδουλευμένο', 'δουλευμένο'}, 'voc': {'δουλευμένε', 'δεδουλευμένε'}, 'gen': {'δουλευμένου', 'δεδουλευμένου'}, 'nom': {'δεδουλευμένος', 'δουλευμένος'}}},
                                            'pl': {'fem': {'acc': {'δεδουλευμένες', 'δουλευμένες'}, 'voc': {'δεδουλευμένες', 'δουλευμένες'}, 'gen': {'δεδουλευμένων', 'δουλευμένων'}, 'nom': {'δεδουλευμένες', 'δουλευμένες'}},
                                                   'neut': {'acc': {'δεδουλευμένα', 'δουλευμένα'}, 'voc': {'δεδουλευμένα', 'δουλευμένα'}, 'gen': {'δεδουλευμένων', 'δουλευμένων'}, 'nom': {'δεδουλευμένα', 'δουλευμένα'}},
                                                   'masc': {'acc': {'δεδουλευμένους', 'δουλευμένους'}, 'voc': {'δεδουλευμένοι', 'δουλευμένοι'}, 'gen': {'δεδουλευμένων', 'δουλευμένων'}, 'nom': {'δεδουλευμένοι', 'δουλευμένοι'}}}}}
