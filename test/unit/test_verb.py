            ...
            {'present': {'active': {
             ...
             'conjunctive': {'active': {'ind': {'sg': {'pri': {'συλλάβω'}, 'sec': {'συλλάβεις'}, 'ter': {'συλλάβει'}},
                 ...
                 'ind': {'sg': {'pri': {'συλληφθώ'}, 'sec': {'συλληφθείς'}, 'ter': {'συλληφθεί'}},
                         'pl': {'pri': {'συλληφθούμε'}, 'sec': {'συλληφθείτε'}, 'ter': {'συλληφθούνε', 'συλληφθούν'}}},
             ...
             'paratatikos': {'active': {'ind': {
                 ...
                 'pl': {'pri': {'συλλαμβάναμε', 'συνελαμβάναμε'}, 'sec': {'συνελαμβάνατε', 'συλλαμβάνατε'},
                        'ter': {'συνελαμβάνανε', 'συλλαμβάνανε', 'συλλάμβαναν', 'συνελάμβαναν'}}}}, 'passive': {'ind': {
                 'sg': {'pri': {'συλλαμβανόμουνα', 'συλλαμβανόμουν'}, 'sec': {'συλλαμβανόσουν', 'συλλαμβανόσουνα'},
