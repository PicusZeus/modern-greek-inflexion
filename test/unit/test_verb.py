...
class VerbTestAll(TestCase):
    ...
    def test_verb_poiw(self):
        ...
        {'present': {'active': {
            'ind': {'sg': {'pri': {'ποιώ', 'ποιάω'}, 'sec': {'ποιείς', 'ποιάς'}, 'ter': {'ποιάει', 'ποιεί', 'ποιά'}},
                    'pl': {'pri': {'ποιούμε', 'ποιάμε'}, 'sec': {'ποιείτε', 'ποιάτε'},
                           'ter': {'ποιάνε', 'ποιούνε', 'ποιούν', 'ποιάν'}}},
            'imp': {'sg': {'sec': {'ποιάγε', 'ποια', 'ποιει', 'ποία'}}, 'pl': {'sec': {'ποιείτε', 'ποιάτε'}}}},
                     'passive': {'ind': {'sg': {'pri': {'ποιούμαι', 'ποιιέμαι'}, 'sec': {'ποιιέσαι', 'ποιείσαι'},
                                                'ter': {'ποιιέται', 'ποιείται'}},
                                         'pl': {'pri': {'ποιούμεθα', 'ποιούμαστε', 'ποιιόμαστε', 'ποιιούμαστε'},
                                                'sec': {'ποιείστε', 'ποιιόσαστε', 'ποιείσθε', 'ποιιέστε'},
                                                'ter': {'ποιιούνται', 'ποιούνται', 'ποιιόνται'}}},
                                 'imp': {'pl': {'sec': {'ποιείστε', 'ποιιόσαστε', 'ποιείσθε', 'ποιιέστε'}}}}},
         'conjunctive': {'active': {'ind': {'sg': {'pri': {'ποιήσω'}, 'sec': {'ποιήσεις'}, 'ter': {'ποιήσει'}},
                                            'pl': {'pri': {'ποιήσουμε'}, 'sec': {'ποιήσετε'},
                                                   'ter': {'ποιήσουνε', 'ποιήσουν'}}},
                                    'imp': {'sg': {'sec': {'ποιήσε'}}, 'pl': {'sec': {'ποιήστε'}}}}, 'passive': {
             'ind': {'sg': {'pri': {'ποιηθώ'}, 'sec': {'ποιηθείς'}, 'ter': {'ποιηθεί'}},
                     'pl': {'pri': {'ποιηθούμε'}, 'sec': {'ποιηθείτε'}, 'ter': {'ποιηθούν', 'ποιηθούνε'}}},
             'imp': {'sg': {'sec': {'ποιήσου'}}, 'pl': {'sec': {'ποιηθείτε'}}}}}, 'aorist': {'active': {
            'ind': {'sg': {'pri': {'ποιήσα', 'ποίησα'}, 'sec': {'ποίησες', 'ποιήσες'}, 'ter': {'ποιήσε', 'ποίησε'}},
                    'pl': {'pri': {'ποιήσαμε'}, 'sec': {'ποιήσατε'}, 'ter': {'ποίησαν', 'ποιήσανε', 'ποιήσαν'}}}},
                                                                                             'passive': {'ind': {'sg': {
                                                                                                 'pri': {'ποιήθηκα'},
                                                                                                 'sec': {'ποιήθηκες'},
                                                                                                 'ter': {'ποιήθηκε'}},
                                                                                                                 'pl': {
                                                                                                                     ...
                                                                                                                     'ter': {
                                                                                                                         'ποιήθηκαν',
                                                                                                                         'ποιηθήκανε'}}}}},
         'paratatikos': {'active': {'ind': {'sg': {'pri': {'ποιούσα'}, 'sec': {'ποιούσες'}, 'ter': {'ποιούσε'}},
                                            'pl': {'pri': {'ποιούσαμε'}, 'sec': {'ποιούσατε'},
                                                   'ter': {'ποιούσανε', 'ποιούσαν'}}}}, 'passive': {'ind': {
             'sg': {'pri': {'ποιόμουν', 'ποιούμουν', 'ποιόμουνα'}, 'sec': {'ποιούσουν', 'ποιόσουνα', 'ποιόσουν'},
                    'ter': {'ποιόταν', 'ποιούνταν', 'ποιούντανε', 'ποιείτο', 'ποιότανε'}},
             'pl': {'pri': {'ποιόμαστε', 'ποιούμαστε', 'ποιούμασταν', 'ποιόμασταν'},
                    'sec': {'ποιούσαστε', 'ποιόσαστε', 'ποιόσασταν', 'ποιούσασταν'},
                    'ter': {'ποιούνταν', 'ποιούντανε', 'ποιόντουσαν', 'ποιούντο', 'ποιόνταν'}}}}},
         'act_pres_participle': {'ποιώντας'}, 'pass_pres_participle': {
            'pl': {'fem': {'nom': {'ποιούμενες'}, 'acc': {'ποιούμενες'}, 'gen': {'ποιούμενων'}, 'voc': {'ποιούμενες'}},
                   'masc': {'nom': {'ποιούμενοι'}, 'acc': {'ποιούμενους'}, 'gen': {'ποιούμενων'},
                            'voc': {'ποιούμενοι'}},
                   'neut': {'nom': {'ποιούμενα'}, 'acc': {'ποιούμενα'}, 'gen': {'ποιούμενων'}, 'voc': {'ποιούμενα'}}},
            'sg': {'fem': {'nom': {'ποιούμενη'}, 'acc': {'ποιούμενη'}, 'gen': {'ποιούμενης'}, 'voc': {'ποιούμενη'}},
                   'masc': {'nom': {'ποιούμενος'}, 'acc': {'ποιούμενο'}, 'gen': {'ποιούμενου'}, 'voc': {'ποιούμενε'}},
                   'neut': {'nom': {'ποιούμενο'}, 'acc': {'ποιούμενο'}, 'gen': {'ποιούμενου'}, 'voc': {'ποιούμενο'}}}},
         'passive_perfect_participle': {
             'pl': {'fem': {'nom': {'ποιημένες'}, 'acc': {'ποιημένες'}, 'gen': {'ποιημένων'}, 'voc': {'ποιημένες'}},
                    'masc': {'nom': {'ποιημένοι'}, 'acc': {'ποιημένους'}, 'gen': {'ποιημένων'}, 'voc': {'ποιημένοι'}},
                    'neut': {'nom': {'ποιημένα'}, 'acc': {'ποιημένα'}, 'gen': {'ποιημένων'}, 'voc': {'ποιημένα'}}},
             'sg': {'fem': {'nom': {'ποιημένη'}, 'acc': {'ποιημένη'}, 'gen': {'ποιημένης'}, 'voc': {'ποιημένη'}},
                    'masc': {'nom': {'ποιημένος'}, 'acc': {'ποιημένο'}, 'gen': {'ποιημένου'}, 'voc': {'ποιημένε'}},
                    'neut': {'nom': {'ποιημένο'}, 'acc': {'ποιημένο'}, 'gen': {'ποιημένου'}, 'voc': {'ποιημένο'}}}}}
        )
        ...
        self.assertDictEqual(
            ...
            {'present':
                ...
                'conjunctive': {
                    'active': {
                        'ind': {
                            'sg': {'pri': {'έρθω', 'έλθω'}, 'sec': {'έλα', 'έρθεις', 'έλθεις'},
                                   'ter': {'έλθει', 'έρθει'}},
                            'pl': {'pri': {'έρθουμε', 'έλθουμε'}, 'sec': {'έρθετε', 'έλθετε', 'ελάτε'},
                                   'ter': {'έρθουνε', 'έρθουν', 'έλθουν', 'έλθουνε'}}},
                        'imp': {'sg': {'sec': {'έλα', 'έρθεις', 'έλθεις'}},
                                'pl': {'sec': {'έρθετε', 'έλθετε', 'ελάτε'}}}}},
                'aorist': {
                    'active': {
