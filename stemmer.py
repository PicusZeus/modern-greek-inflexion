...
from modern_greek_stemmer.resources import *
from models.coniugation import *
...
def create_regular_perf_root(verb, voice='active'):
    ...
    irregular_active_roots = [['βάλλ', 'βάλ'], ['λαμβάν', 'λάβ'], ['βάζ', 'βάσ'], ['βάζ', 'βάλ'], ['βγάζ', 'βγάλ'],
                              ['λαβαίν', 'λάβ'], ['αγγέλν','αγγείλ'], ['αγγέλλ', 'αγγείλ'], ['στάν', 'στήσ'],
                              ['σταίν', 'στήσ'], ['πίπτ', 'πέσ'], ['φέρν', 'φέρ'], ['φεύγ','φύγ'], ['άγ', 'αγάγ'],
                              ['γέρν', 'γεράσ'], ['πάσχ', 'πάθ'], ['σέρν', 'σύρ'], ['τέμν', 'τμήσ'], ['εφιστ', 'επιστήσ'],
                              ['καθιστ', 'καταστήσ'], ['λανθάν', 'λάθ'], ['λαγχάνω', 'λάχ'], ['λαχαίν', 'λάχ'],
                              ['αίρν', 'άρ'], ['αίρ', 'άρ'], ['δίν', 'δώσ'], ['δίδ', 'δώσ'], ['μέν', 'μείν'],
                              ['στέλν', 'στείλ'], ['στέλλ', 'στείλ'], ['πλέν', 'πλύν'], ['βαίν', 'β'], ['βγαίν', 'βγ'],
                              ['αυξάν', 'αυξήσ'], ['μεθ', 'μεθύσ'], ['σπέρν', 'σπείρ'], ['αλίσκ', 'αλώσ'],
                              ['μπαίν', 'μπ'], ['μην', 'μηνύσ'], ['πλέ', 'πλεύσ'], ['πνέ', 'πνεύσ'], ['ρέ', 'ρεύσ'],
                              ['βρίσκ', 'βρ'], ['πίν', 'πι'], ['τρώ', 'φά'], ['λέ', 'π'], ['λέγ', 'π,λέξ'], ['τρώγ', 'φάγ'],
                              ['δέρν', 'δείρ'], ['κλίν', 'κλίν'], ['κάν', 'κάν'], ['μαθαίν', 'μάθ'], ['παθαίν',
                              'πάθ'],  ['πεθαίν', 'πεθάν'], ['βλέπ', 'δ'], ['θνήσκ', 'θάν'], ['τείν', 'τείν'],
                              ['πέφτ', 'πέσ'], ['πέπτ', 'πέσ'], ['πηγαίν', 'πά'], ['τυχαίν', 'τύχ'], ['πετυχαίν', 'πετύχ'],
                              ['τυγχάν', 'τύχ'], ['άσχ', 'ασχέσ'], ['τρέφ', 'θρέψ'], ['ελαύν', 'ελάσ'],
                              ['κρέμ', 'κρεμάσ'], ['ευρίσκ', 'εύρ'], ['έχ', 'άσχ'], ['έλκ', 'έλκυσ'], ['θαρρ', 'θαρρέψ'],
                              ['χέ', 'χύσ'], ['νιστ', 'στήσ'], ['ιστάν', 'αστήσ'], ['δεικνύ', 'δείξ'], ['μειγνύ', 'μείξ'],
                              ['ρηγνύ', 'ρήξ'], ['γιγνώσκ', 'γνώσ'], ['πηγνύ', 'πήξ']

                              ]

    irregular_passive_roots = [['βάλλ', 'βληθ'], ['βάζ', 'βαλθ'], ['βγάζ', 'βγαλθ'], ['λαμβάν', 'ληφθ'], ['λαβαίν', 'ληφθ'],
                               ['ρήγνυ', 'ραγ,ρηχθ'], ['ρηγνύ', 'ραγ,ρηχθ'], ['αίρν', 'αρθ'], ['γράφ', 'γραφ,γραφτ'],
                               ['αίρ', 'αρθ'], ['δέρν', 'δαρθ'], ['άσχ', 'ασχεθ'], ['καλ', 'κληθ'], ['εύχ', 'ευχηθ'],
                               ['δίν', 'δοθ'], ['δίδ', 'δοθ'],['υπόσχ', 'υποσχεθ'], ['κόπτ', 'κοπ'], ['κόβ', 'κοπ'],
                               ['ακού', 'ακουστ'], ['στέλν', 'σταλθ,σταλ'], ['στέλλ', 'σταλθ,σταλ'], ['πλέν', 'πλυθ'],
                               ['έρχ', 'έλθ,έρθ,`ρθ,`λθ'], ['κάθ', 'καθίσ,κάτσ'], ['γίν', 'γίν'], ['καί', 'κα'],
                               ['στέκ', 'σταθ'], ['στήν', 'σταθ'], ['οφείλ', 'οφεληθ'], ['πνίγ', 'πνιγ,πνιχτ'],
                               ['θέτ', 'τεθ'], ['βλέπ','ιδωθ'], ['λέγ', 'ειπωθ,ιπωθ,λεγ'], ['τείν', 'ταθ'], ['φαίν', 'φαν'],
                               ['σέρν', 'συρθ'], ['αυξάν', 'αυξηθ'], ['σπέρν', 'σπαρθ'], ['αλίσκ', 'αλωθ'], ['τρέφ', 'τραφ'],
                               ['τέμν', 'τμηθ'], ['κρέμ', 'κρεμαστ'], ['βρίσκ', 'βρεθ'], ['τρώ', 'φαγωθ'], ['λέ', 'ειπωθ'],
                               ['τρώγ', 'φαγωθ'], ['αφήν', 'αφεθ'], ['τρέπ', 'τραπ'], ['στρέφ', 'στραφ'], ['τίθε', 'τεθ'],
                               ['σέβ', 'σεβαστ'], ['χαίρ', 'χαρ'], ['λέγ', 'λεγ'], ['επαφίε', 'επαφεθ'], ['ρήγνυ', 'ραγ'],
                               ['ίστ', 'αστ'], ['θίστ', 'ταστ'], ['έλκ', 'ελκυστ'], ['χέ', 'χυσθ'], ['νιστ', 'σταθ'],
                               ['ελαύν', 'ελαθ'], ['ιστάν', 'ασταθ'], ['δεικνύ', 'δειχθ'], ['δείκνυ', 'δειχθ'],
                               ['μειγνύ', 'μειχθ'], ['γιγνώσκ', 'γνωσθ'], ['πηγνύ', 'παγ']]
                ...
                for stem in pair[1].split(','):
                    ...
                    if len(root) >= len(pair[0]) and root[-len(pair[0]):] == pair[0]:
                        ...
                        if (beta_perf_root + 'ω' in greek_corpus) or (
                            ...
                            mult_perf_roots.append(beta_perf_root)

                if mult_perf_roots:
                    perf_root = ','.join(mult_perf_roots)
                    irregular = True
                    multiple_stems = True
    ...
    if conjugation in ['con1_act', 'con1_pass', 'con1_act_modal'] and not perf_root:
        ...
        if not ((perf_root + 'ω' in greek_corpus) or (perf_root + 'ου' in greek_corpus) or perf_root + 'ει'  in
        greek_corpus):

            perf_root = root + 'άσ'
            if not ((perf_root + 'ω' in greek_corpus) or (perf_root + 'ου' in greek_corpus) or perf_root + 'ει'  in greek_corpus):
                perf_root = root + 'έσ'
                if not ((perf_root + 'ω' in greek_corpus) or (perf_root + 'ου' in greek_corpus) or perf_root + 'ει'  in greek_corpus):
    ...
    if voice == 'passive' and conjugation in ['con1_act', 'con1_pass', 'con1_pass_modal', 'con2_pass_modal', 'con2d_act'] and not \
            irregular:
    ...
    if voice == 'passive' and conjugation in ['con2a_act', 'con2b_act', 'con2c_act', 'con2a_pass', 'con2b_pass', 'con2e_pass',
    ...
    if not perf_root:
        # some last ditch efforts to cover all cases
        if verb == 'ενδείκνυμαι':
            perf_root = 'ενδειχθ'
        elif verb == 'αντενδείκνυμαι':
            perf_root = 'αντενδειχθ'
        elif verb == 'προτίθεμαι':
            perf_root = 'προτεθ'
        else:
            raise ValueError

    if (perf_root and ((perf_root + 'ω' in greek_corpus) or (perf_root + 'ώ' in greek_corpus) or (perf_root + 'εί' in greek_corpus))) or root[-3:] == 'ποι' or multiple_stems:
...
START
################### classes for mimicking sqlalchemy classes ############
...
class Ending:
    def __init__(self, number, person, ending):
...
def recognize_active_non_past_conjugation(verb, aspect='imperf', tense='fin', voice='active'):
    ...
    # συνηρημενα
    elif ((verb[-1:] == 'ω' and verb[-2] in ['έ', 'ά', 'ώ']) and (verb[-3:] not in ['δέω', 'ρέω', 'χέω'] and verb[-4:]
                                                                  not
                                                                  in [
        'πνέω', 'πλέω'])) or (verb[-1] == 'ω' and len(verb) > 2 and verb[-3:-1] in ['αί', 'ού']) or verb == 'πάω':
        ...
        # i understand that it is dangerous in case a verb on αω is given in contracted form,
        # that's why, in order to save some unneeded hassle only uncontracted verbs are allowed
        # as input in this function
