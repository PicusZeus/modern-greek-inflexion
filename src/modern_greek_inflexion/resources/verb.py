...
irregular_active_roots = \
    [['βρίθω', None], ['ξέρω', None],
     ...
     ['προσήκω', None], ['παραέχω', None], ['βγάν', 'βγάλ'], ['βάν', 'βάλ'],
     ['χατίζω', None],['πάγω', None], ['παριστ', 'παραστήσ'], ['δεικνύ', 'δείξ'], ['μανθάν', 'μάθ'],
     ['ταλασιουργώ', None], ['βόσκ', 'βοσκήσ'], ['θνήσκ', 'θάν'], ['ευρίσκ', 'εύρ'],['ανταίν', 'αντέσ'],
     ...
     ['αίρ', 'άρ'], ['τιτρώσκ', 'τρώσ'], ['καίγ', 'κάψ'], ['μετέχ', 'μετάσχ,μετέχ'], ['εξέχ', 'εξέχ,εξάσχ'],
     ...
     ['σπά', 'σπάσ'], ['θέλ', 'θελήσ'], ['κρίν', 'κρίν'], ['νέμ', 'νείμ'],['σβεννύω', 'σβήσ'], ['συρρέ', 'συρρεύσ'], ['διαρρέ', 'διαρρεύσ'], ['ρρέω', 'ρρεύσ'],
     ['δεικνύ', 'δείξ'], ['μειγνύ', 'μείξ'], ['μιγνύ', 'μίξ'], ['ρηγνύ', 'ρήξ'], ['γιγνώσκ', 'γνώσ'], ['πηγνύ', 'πήξ'], ['τρώ', 'φά,φάγ'],
...
irregular_passive_roots = \
    [['υπέρκειμαι', None],
     ...
     ['κωλύομαι', None],
     ['πηγαινοέρχομαι', None],
     ['τεκμαίρομαι', None], ['ελαύνω', None],
     ['ακκίζομαι', None],
# ['διασπέρν', 'διασπαρθ'], ['αποσπέρν', 'αποσπαρθ'],
     ['ευθύνομαι', None], ['σπέρνω', 'σπαρ,σπαρθ'],
     ['οφείλομαι', None], ['καίγ', 'κάηκ'], ['μειγνύ', 'μειχθ'],['μιγνύ', 'μιχθ'], ['ομνύω', 'ομοσθ'],
     ['απεχθάνομαι', None], ['τιτρώσκ', 'τρωθ'],
     ['μάχομαι', None], ['βάλλ', 'βληθ'], ['βάζ', 'βαλθ'], ['αίρ', 'αρθ'], ['βγάζ', 'βγαλθ'], ['λαμβάν', 'ληφθ'],
     ['πον', 'πονεθ'],['μιμνήσκ', 'μνησθ'], ['δεικνύ', 'δειχθ'], ['τέμν', 'τμηθ'],
     ...
     ['αυξάν', 'αυξηθ'],  ['αλίσκ', 'αλωθ'], ['τρέφ', 'τραφ'], ['τέμν', 'τμηθ'], ['κρέμ', 'κρεμαστ'],
     ...
     ['χέ', 'χυσθ'],['ακούγ', 'ακουστ'], ['δέ', 'δεηθ'], ['ρρέω', 'ρρευτ'], ['κορεννύω', 'κορεσθ'],
     ['νιστ', 'σταθ'], ['ελαύν', 'ελαθ'], ['ιστάν', 'ασταθ'], ['δεικνύ', 'δειχθ'], ['δείκνυ', 'δειχθ'],
     ['μειγνύ', 'μειχθ'], ['γιγνώσκ', 'γνωσθ'], ['πηγνύω', 'πυχθ,παγ'], ['ενδείκνυ', 'ενδειχθ'], ['ευρίσκ', 'ευρεθ'],
     ['τρώ', 'φαγωθ'], ['τρώγ', 'φαγωθ'], ['σπά', 'σπαστ'], ['φυλ', 'φυλαχτ'], ['άγ', 'αχθ'], ['φθείρ', 'φθαρ'],
     ['φθείρ', 'φθαρθ'], ['πλήττ', 'πλαγ,πληγ'], ['πλήσσ', 'πλαγ,πληγ'], ['σταίν', 'στ'], ['σπείρω', 'σπαρ,σπαρθ'],
     ]
...
irregular_passive_perfect_participles = {'άγω': 'ηγμένος', 'έχομαι': None, 'αγανακτώ': 'αγανακτισμένος',
                                         ...
                                         'ανάβω': 'αναμμένος', 'αναγκάζω': 'αναγκασμένος', 'ανήκω': None, 'πέτομαι': None,
                                         'δίνω': 'δοσμένος,δεδομένος', 'κάθομαι': 'καθισμένος', 'καίω': 'κεκαυμένος,καμένος,κεκαμμένος',
                                         ...
                                         'αποκτώ': 'αποκτημένος', 'αποτελούμαι': 'αποτελεσμένος', 'λαμβάνω': 'ειλημμένος',
                                         ...
                                         'γυρίζω': 'γυρισμένος', 'τρέπω': 'τετραμμένος', 'σπέρνω': 'σπαρμένος,εσπαρμένος',
                                         ...
                                         'ζητάω': 'ζητημένος', 'ζω': 'βιωμένος', 'τρέφω' : 'θρεμμένος', 'τρέφομαι': 'θρεμμένος',
...
irregular_active_aorists = {'βαίνω': 'βηκα', 'εισέχω': "εισείχα", 'μπαίνω': 'μπήκα', 'αναθιβάλλω': 'αναθίβαλα,ανεθίβαλα',
                            'αίρω': 'ήρα', 'βγαίνω': 'βγήκα', 'βρίσκω': 'βρήκα', 'ρηγνύω': 'έρρηξα', 'κατεβαίνω': 'κατέβη,κατέβηκα',
                            ...
                            'τρώω': 'έφαγα', 'τρώγω': 'έφαγα', 'βλέπω': 'είδα', 'πάω': 'πήγα','ευρίσκω': 'ηύρα','παγαίνω': 'πήγα',
                            'καταλαβαίνω': 'κατάλαβα', 'καταλαμβάνω': 'κατέλαβα', 'κατέχω': 'κατείχα', 'συγκατέχω': 'συγκατείχα', 'γινώσκω': 'έγνωσα'}

irregular_active_paratatikos = {'πάω': 'πήγαινα', 'έλκω': 'είλκα', 'άρχω': 'ήρχα', 'έρπω': 'είρπα', 'φινίρω': 'φινίριζα',
                                'άδω': '',  'πάγω': 'πήγα', 'ρέω': 'έρρεα', "επιδράμω": "επέδραμα", "ανήκω": "ανήκα,άνηκα",
                                'σπάω': 'έσπαγα', 'έχω': 'είχα', 'εξεύρω': 'ήξευρα', 'δαγκάνω': 'δάγκανα', 'όψομαι': ''}
...
prefixes_before_augment = {'ανα': 'αν', 'διακατ': 'διακατ', 'αν': 'αν', 'δια': 'δι', 'δι': 'δι', 'εκ': 'εξ', 'παρεισ': 'παρεισ',
                           ...
                           'υπ': 'υπ', 'αμφι': 'αμφ', 'επι': 'επ', 'επ': 'επ', 'εισ': 'εισ', 'συμ': 'συν', 'καταπρο': 'καταπρο',
                           ...
                           'εν': 'εν', 'εμ': 'εν', 'εγ': 'εν', 'εγκατα': 'εγκατ', 'υφ': 'υφ', 'επισυμ': 'επισυν', "προεν": 'προεν', 'ανακατα': 'ανακατ',
                           'καλα': 'καλα', 'κουτσο': 'κουτσο', 'ξανα': 'ξανα', 'εξ': 'εξ', 'συμμετ': 'συμμετ', 'διασυμ': 'διασυν', 'συνυπo': 'συνυπ',
                            'επανα': 'επαν', 'επαν': 'επαν', 'αντι': 'αντ', 'αντ': 'αντ','περιδια':'περιδι', 'ξαπο': 'ξαπ','προκατα': 'προκατ',
