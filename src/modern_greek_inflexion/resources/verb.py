...
irregular_active_roots = \
    [['βρίθω', None], ['ξέρω', None],
     ...
     ['κωλύω', None],
     ['παιδιακίζω', None],
     ['σιαλίζω', None],['δαγκάν', 'δαγκάσ'], ['παίρν', 'πάρ'],
     ...
     ['τρώγ', 'φά,φάγ'], ['πά', 'πά'], ['φυλ', 'φυλάξ'], ['παγαίν', 'πά']
     ]
...
irregular_passive_roots = \
    [['υπέρκειμαι', None],
     ...
     ['πον', 'πονεθ'],['μιμνήσκ', 'μνησθ'], ['δεικνύ', 'δειχθ'],
...
irregular_active_aorists = {'βαίνω': 'βηκα', 'εισέχω': "εισείχα", 'μπαίνω': 'μπήκα', 'αίρω': 'ήρα', 'βγαίνω': 'βγήκα', 'βρίσκω': 'βρήκα',
...
irregular_active_paratatikos = {'πάω': 'πήγαινα',  'πάγω': 'πήγα', 'σπάω': 'έσπαγα', 'έχω': 'είχα', 'εξεύρω': 'ήξευρα', 'δαγκάνω': 'δάγκανα'}
