...
conjugations = {
    ...
    CON2AB_PASS: {SG: {PRI: ['ώμαι'], SEC: ['άσαι'], TER: ['άται']}, PL: {PRI: ['ώμεθα'], SEC: ['άσθε'],
                                                                          TER: ['ώνται']}},
    ...
    PARAT2AB_PASS: {SG: {PRI: ['ιόμουν', 'ιόμουνα'], SEC: ['ιόσουν', 'ιόσουνα'], TER: ['ιόταν', 'ιότανε', 'άτο']},
                    PL: {PRI: ['ιόμασταν', 'ιόμαστε'], SEC: ['ιόσαστε', 'ιόσασταν'],
                         TER: ['ιόνταν', 'ιούνταν', 'ιόντουσαν', 'ώντο']}},
    PARAT2AC_PASS: {SG: {PRI: ['όμουν'], SEC: ['όσουν'], TER: ['όταν', 'άτο']},
    ...
    IMPER_PASS_CONT_2AB: {PL: {SEC: ['άσθε']}},
