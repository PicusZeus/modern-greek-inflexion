...
irregular_active_roots = {
    ...
    'ταυτογνωμώ': None, 'κατέχ': 'κατέχ,κατάσχ',
    'απέχ': 'απέχ,απάσχ', 'ισαπέχ': 'ισαπέχ,ισαπάσχ', 'μεθύσκ': 'μεθύσ',
    'αγαθοφέρνω': None, 'υπερέχ': 'υπερέχ,υπεράσχ',
    'επέχ': 'επέχ,επάσχ', 'εισέχ': 'εισέχ,εισάσχ', 'συνέχ': 'συνέχ',
    'μέλλει': None, 'μιμνήσκ': 'μνήσ', 'ενέχ': 'ενέχ,ενάσχ',
    'υπέχ': 'υπέχ,υπάσχ', 'παρέχ': 'παράσχ,παρέχ',
    'θεόω': None, 'δ': 'δεήσ', 'γινώσκ': 'γνώσ',
    'περιέχ': 'περιέχ', 'γηράσκ': 'γεράσ', 'διδράσκ': 'δράσ',
    'απάδω': None, 'ανήκω': None, 'βιβρώσκ': 'βρώσ',
    'αντέχ': 'αντέξ', 'θρώσκ': 'θορ', 'αρέσκ': 'αρέσκ',
    'ανεβαίν': 'ανέβ,ανεβ', 'δέ': 'δεήσ', 'περιμέν': 'περιμέν',
    'πον': 'πονέσ', 'κατεβαίν': 'κατέβ,κατεβ',
    ...
    'στάν': 'στήσ', 'σταίν': 'στήσ',
    'πίπτ': 'πέσ', 'φέρν': 'φέρ',
    'φεύγ': 'φύγ', 'άγ': 'αγάγ',
    'πάσχ': 'πάθ', 'σέρν': 'σύρ', 'τέμν': 'τμήσ', 'εφιστ': 'επιστήσ',
    'καθιστ': 'καταστήσ', 'λανθάν': 'λάθ',
    'λαγχάνω': 'λάχ', 'λαχαίν': 'λάχ', 'αίρν': 'άρ',
    'δίν': 'δώσ', 'δίδ': 'δώσ', 'μέν': 'μείν',
    'στέλν': 'στείλ', 'στέλλ': 'στείλ', 'πλέν': 'πλύν',
    'βαίνω': 'β', 'βγαίνω': 'βγ', 'αυξάν': 'αυξήσ',
    'μεθ': 'μεθύσ', 'σπέρν': 'σπείρ', 'αλίσκ': 'αλώσ',
    'μπαίν': 'μπ', 'μην': 'μηνύσ', 'πλέ': 'πλεύσ',
    'πνέ': 'πνεύσ', 'ρέ': 'ρεύσ', 'βρίσκ': 'βρ',
    'πίν': 'πι', 'λέ': 'π', 'λέγ': 'π,λέξ',
    'δέρν': 'δείρ', 'κλίν': 'κλίν',
    'κάν': 'κάν', 'μαθαίν': 'μάθ', 'παθαίν': 'πάθ',
    'πεθαίν': 'πεθάν', 'βλέπ': 'δ,ίδ|βλέψ', 'θνήσκ': 'θάν',
    'τείν': 'τείν', 'πέφτ': 'πέσ',
    'πέπτ': 'πέσ', 'πηγαίν': 'πά',
    'τυχαίν': 'τύχ', 'πετυχαίν': 'πετύχ',
    'τυγχάν': 'τύχ', 'άσχ': 'ασχέσ', 'τρέφ': 'θρέψ',
    'ελαύν': 'ελάσ', 'κρέμ': 'κρεμάσ', 'ευρίσκ': 'εύρ',
    'έχ': 'άσχ', 'έλκ': 'έλκυσ', 'θαρρ': 'θαρρέψ',
    'χέ': 'χύσ', 'νιστ': 'στήσ', 'ιστάν': 'αστήσ', 'φρέ': 'φρήσ',
    'σπά': 'σπάσ', 'θέλ': 'θελήσ', 'κρίν': 'κρίν',
    'νέμ': 'νείμ', 'σβεννύω': 'σβήσ', 'συρρέ': 'συρρεύσ',
    'διαρρέ': 'διαρρεύσ', 'ρρέω': 'ρρεύσ',
    'δεικνύ': 'δείξ', 'μειγνύ': 'μείξ', 'μιγνύ': 'μίξ',
...
irregular_passive_perfect_participles = {'άγω': 'ηγμένος', 'έχομαι': None,
                                         'αγανακτώ': 'αγανακτισμένος',
                                         'αποτυχαίνω': 'αποτυχημένος', 'κάνω': 'καμωμένος', 'λανθάνω': 'λανθασμένος',
                                         'αγαπάω': 'αγαπημένος',
                                         'αγωνίζομαι': 'αγωνισμένος', 'κάμνω': 'καμωμένος',
                                         ...
                                         'λαμβάνω': 'ειλημμένος',
                                         'αποφασίζω': 'αποφασισμένος',
                                         'αρέσω': None, 'κερδαίνω': 'κερδαιμένος',
                                         'βρέχω': 'βρεγμένος', 'αστειεύομαι': None, 'αφήνω': 'αφημένος',
                                         'βάζω': 'βαλμένος', 'βάφω': 'βαμμένος',
                                         'βαριέμαι': 'βαρεμένος',
                                         'βγάζω': 'βγαλμένος', 'βγαίνω': None, 'βιάζομαι': 'βιασμένος',
                                         'βλέπω': 'ιδωμένος',
                                         'βοηθάω': 'βοηθημένος', 'βρίσκομαι': None,
                                         ...
                                         'δανείζω': 'δανεισμένος', 'δείχνω': 'δειγμένος',
                                         'δένω': 'δεμένος',
