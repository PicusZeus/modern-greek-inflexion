...
irregular_active_roots = {
    ...
    'ταλασιουργώ': None, 'βόσκ': 'βοσκήσ',  'ανταίν': 'αντέσ',
    ...
    'βάζω': 'βάλ', 'βγάζ': 'βγάλ', 'λαβαίν': 'λάβ', 'αγγέλν': 'αγγείλ', 'αγγέλλ': 'αγγείλ',
...
irregular_active_aorists = {'βαίνω': 'βηκα', 'εισέχω': "εισείχα", 'μπαίνω': 'μπήκα',
