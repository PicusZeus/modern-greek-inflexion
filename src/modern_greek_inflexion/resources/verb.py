...
irregular_active_roots = \
    [['βρίθω', None], ['ξέρω', None],
     ...
     ['παιδιακίζω', None],
     ['σιαλίζω', None],
     ['προσήκω', None], ['παραέχω', None],
     ['χατίζω', None],['πάγω', None], ['παριστ', 'παραστήσ'], ['δεικνύ', 'δείξ'],
...
irregular_active_paratatikos = {'πάω': 'πήγαινα',  'πάγω': 'πήγα', 'σπάω': 'έσπαγα', 'έχω': 'είχα', 'εξεύρω': 'ήξευρα'}
