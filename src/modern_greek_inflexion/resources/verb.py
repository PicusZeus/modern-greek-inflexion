...
irregular_active_roots = \
    [['βρίθω', None], ['ξέρω', None],
     ...
     ['ρηγνύω', None],['καίγ', 'κάψ'],['κορεννύ', 'κορέσ'],
...
irregular_passive_roots = \
    [['υπέρκειμαι', None],
     ...
     ['απεχθάνομαι', None], ['τιτρώσκ', 'τρωθ'], ['διασπέρν', 'διασπαρθ'], ['αποσπέρν', 'αποσπαρθ'],
...
irregular_passive_perfect_participles = {'άγω': 'ηγμένος', 'έχομαι': None, 'αγανακτώ': 'αγανακτισμένος',
                                         ...
                                         'είμαι': None, 'εκφράζω': 'εκφρασμένος',
...
irregular_active_aorists = {'βαίνω': 'βηκα', 'εισέχω': "εισείχα", 'μπαίνω': 'μπήκα', 'αναθιβάλλω': 'αναθίβαλα,ανεθίβαλα',
                            ...
                            'πηγαίνω': 'πήγα', 'παίρνω': 'πήρα', 'λέω': 'είπα', 'ομνύω': 'ώμοσα',
...
irregular_active_paratatikos = {'πάω': 'πήγαινα', 'έλκω': 'είλκα', 'άρχω': 'ήρχα', 'έρπω': 'είρπα',
                                'άδω': '',  'πάγω': 'πήγα', 'ρέω': 'έρρεα', "επιδράμω": "επέδραμα",
                                'σπάω': 'έσπαγα', 'έχω': 'είχα', 'εξεύρω': 'ήξευρα', 'δαγκάνω': 'δάγκανα'}
...
prefixes_detachable = {'πολυ': 'πολυ', 'καλα': 'καλα', 'κουτσο': 'κουτσο', 'ξανα': 'ξανα', 'κρουστο': 'κρουστο','λαθρ': 'λαθρ',
                       'αγανο': 'αγανο', 'πρωτο': 'πρωτο', 'xolo': 'χολο', 'προικο': 'προικο', 'λογο': 'λογο', 'λαθρα': 'λαθρα',
                        'περνο': 'περνο', 'κακο': 'κακο', 'καταπρο': 'καταπρο', 'επανα': 'επαν', 'ξερο': 'ξερο', 'αγγελο': 'αγγελο',
                       'μαυρο': 'μαυρο', 'αγγλο': 'αγγλο', 'ψιλο': 'ψιλο', 'φωτοσυν': 'φωτοσυν', 'ματα': 'ματα', 'κρυφ': 'κρυφ',
                       'ματ': 'ματ', 'κωδωνο': 'κωδωνο', 'διαολο': 'διαολο', 'αιμο': 'αιμο', 'υδρο': 'υδρο', 'παραεισ': 'παραεισ', 'ξε': 'ξ' }

prefixes_detachable_weak = {'επαναπροσ': 'επαναπροσ', 'διασυμπερι': 'διασυμπερι', 'συμ': 'συν', 'αναπροσ': 'αναπροσ', 'προσ': 'προσ',
...
prefixes_before_augment = {'ανα': 'αν', 'διακατ': 'διακατ', 'αν': 'αν', 'δια': 'δι', 'δι': 'δι', 'εκ': 'εξ', 'παρεισ': 'παρεισ',
                           ...
                           'απ': 'απ', 'ισαπ': 'ισαπ', 'προ': 'προ', 'κατα': 'κατ', 'κατ': 'κατ',
