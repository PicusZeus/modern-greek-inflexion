...
irregular_active_aorists = {'εισέχω': "εισείχα",
                            ...
                            'πηγαίνω': 'πήγα', 'παίρνω': 'πήρα', 'λέω': 'είπα',
                            'ομνύω': 'ώμοσα', 'βαίνω': 'βήκα,έβη',
                            'λέγω': 'είπα', 'πίνω': 'ήπια', 'παίω': 'έπαισα',
                            'ρέω': 'έρρευσα', "επιδράμω": "επέδραμα",
                            'τρώω': 'έφαγα', 'τρώγω': 'έφαγα',
                            'βλέπω': 'είδα', 'πάω': 'πήγα', 'ευρίσκω': 'ηύρα',
                            'παγαίνω': 'πήγα',
...
para_detachable_never = ['παραφθείρω', 'παρατρέπω', 'παραφράζω', 'παραπέμπω', 'παραβλάπτω', 'παραβάλλω', 'παραγγέλλω',
                         'παραβιάζω', 'παραβαίνω', 'παρακάμπτω', 'παρακούω', 'παραλλάζω', 'παρακμάζω', 'παραλύω',
                         'παρατείνω', 'παραπείθω',
                         'παραπέφτω', 'παρασταίνω', 'παραρρέω', 'παρασέρνω', 'παραστέκω', 'παραπλέω', 'παραπαίω',
                         'παρασύρω', 'παραλλάσσω', 'παρατάσσω']

para_detachable_only = ['παραβγαίνω', 'παρατρώγω', 'παρατρέχω', 'παραδέρνω', 'παραέχω', 'παρακάνω', 'παραλέω',
                        'παραμπαίνω', 'παραρίχνω', 'παραψένω', 'παραψήνω', 'παραπίνω', 'παραπαίρνω', 'παρατρώω',
