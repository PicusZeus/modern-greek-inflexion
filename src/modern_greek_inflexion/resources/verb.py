...
irregular_active_roots = \
    [['βρίθω', None], ['ξέρω', None],
     ...
     ['ταλασιουργώ', None], ['βόσκ', 'βοσκήσ'], ['θνήσκ', 'θάν'], ['ευρίσκ', 'εύρ'],
...
irregular_passive_perfect_participles = {'άγω': 'ηγμένος', 'έχομαι': None, 'αγανακτώ': 'αγανακτισμένος',
                                         ...
                                         'αποφασίζω': 'αποφασισμένος','αρέσω': None,
...
irregular_active_paratatikos = {'πάω': 'πήγαινα', 'πάγω': 'πήγα', 'σπάω': 'σπαγα', 'έχω': 'είχα'}
