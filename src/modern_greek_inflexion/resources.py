...
irregular_active_aorists = {'βαίνω': 'βηκα',  'μπαίνω': 'μπήκα', 'αίρω': 'ήρα', 'βγαίνω': 'βγήκα', 'βρίσκω': 'βρήκα', 'πηγαίνω': 'πήγα', 'παίρνω': 'πήρα', 'λέω': 'είπα', 'λέγω': 'είπα', 'πίνω': 'ήπια', 'τρώω': 'έφαγα', 'τρώγω': 'έφαγα', 'βλέπω': 'είδα'}
...
'parat2a_pass': {SG: {PRI: ['ιόμουν', 'ιόμουνα'], SEC: ['ιόσουν', 'ιόσουνα'], TER: ['ιόταν', 'ιότανε']},
                 PL: {PRI: ['ιόμασταν', 'ιόμαστε'], SEC: ['ιόσασταν', 'ιόσαστε'], TER: ['ιούνταν', 'ιόνταν', 'ιόντουσαν']}},
'parat2b_pass': {SG: {PRI: ['ούμουν'], SEC: ['ούσουν'], TER: ['είτο', 'ούνταν', 'ούντανε']},
                 PL: {PRI: ['ούμασταν', 'ούμαστε'], SEC: ['ούσασταν', 'ούσαστε'], TER: ['ούνταν', 'ούντο', 'ούντανε']}},
