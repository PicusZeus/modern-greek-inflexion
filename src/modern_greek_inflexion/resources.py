...
irregular_passive_roots = \
    [['βάλλ', 'βληθ'], ['βάζ', 'βαλθ'], ['αίρ', 'αρθ'], ['βγάζ', 'βγαλθ'], ['λαμβάν', 'ληφθ'], ['λαβαίν', 'ληφθ'],
     ...
     ['τρώ', 'φαγωθ'], ['τρώγ', 'φαγωθ'], ['σπά', 'σπαστ'], ['φυλ', 'φυλαχτ'], ['άγ', 'αχθ'], ['φθείρ', 'φθαρ'], ['φθείρ', 'φθαρθ']]

irregular_passive_perfect_participles = {'άγω': 'ηγμένος', 'έχομαι': None,  'αγανακτώ': 'αγανακτισμένος', 'αποτυχαίνω': 'αποτυχημένος', 'κάνω': 'καμωμένος',
                                         ...
                                         'φέρνω': 'φερμένος', 'φεύγω': None, 'φοβάμαι': 'φοβισμένος', 'φοράω': 'φορεμένος',
